        ...
        {!showForm ? (
          ...
          <div className="mx-auto w-full max-w-[1360px] relative lg:h-[600px] p-4 lg:p-7 overflow-hidden">
            ...
            <div className="relative z-[1] grid grid-cols-1 lg:grid-cols-[510px_1fr] gap-6 lg:gap-10 items-start h-full">
              ...
              {/* Right — form */}
              <div className="bg-white p-4 lg:p-6 lg:h-[544px] overflow-auto">
                <form onSubmit={(e) => e.preventDefault()} className="grid grid-cols-2 gap-x-4 lg:gap-x-5 gap-y-2.5 h-full content-start">
                  ...
                  <div className="col-span-2 flex items-center justify-between gap-3 pt-1">
                    ...
                    <button
                      type="button"
                      onClick={() => setShowForm(false)}
                      className="lg:hidden inline-flex items-center gap-2 border border-[#1A3189] text-[#1A3189] hover:bg-[#1A3189] hover:text-white px-6 py-2.5 text-[13px] font-medium transition-colors"
                    >
                      <ArrowLeft size={14} />
                      <span>이전으로</span>
                    </button>
                    ...
                    <button
                      type="submit"
                      className="inline-flex items-center gap-2 bg-[#1A3189] hover:bg-[#005EB8] text-white px-6 py-2.5 text-[13px] font-medium transition-colors"
                    >
                      <span>제출하기</span>
                      <ArrowRight size={14} />
                    </button>
